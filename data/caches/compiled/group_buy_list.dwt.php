        ...
        <dl>
          ...
          <dd class="dd-price">
            <span class="pull-left">
              <strong><?php echo $this->_var['lang']['price']; ?>：<b class="ect-colory"><?php echo $this->_var['groupbuy']['cur_price']; ?></b></strong>
              </span></dd>
          <dd class="dd-num">
            <span class="pull-left"><i class="fa fa-eye"></i> <?php echo $this->_var['groupbuy']['click_num']; ?><?php echo $this->_var['lang']['scan_num']; ?></span>
            <span class="pull-right"><?php echo $this->_var['lang']['sort_sales']; ?>：<?php echo $this->_var['groupbuy']['sales_count']; ?><?php echo $this->_var['lang']['piece']; ?></span> </dd>
