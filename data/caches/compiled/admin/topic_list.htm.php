...
?>
    <tr>
      ...
      <td align="center"><a href="../index.php?c=topic&topic_id=<?php echo $this->_var['topic']['topic_id']; ?>" title="<?php echo $this->_var['lang']['view']; ?>" target="_blank"><?php echo $this->_var['lang']['view']; ?></a>    <a href="topic.php?act=edit&topic_id=<?php echo $this->_var['topic']['topic_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><?php echo $this->_var['lang']['edit']; ?></a>
      ...
      <a href="ads.php?act=add&ad_name=<?php echo $this->_var['topic']['title']; ?>&ad_link=<?php echo $this->_var['topic']['url']; ?>&topic_id=<?php echo $this->_var['topic']['topic_id']; ?>"><?php echo $this->_var['lang']['publish_to_ads']; ?></a>
