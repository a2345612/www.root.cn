...
<form method="post" action="group_buy.php?act=insert_update" name="theForm" enctype="multipart/form-data"  onsubmit="return validate()">
<div class="main-div">
...
?>
  ...
  <tr>
    ...
    <tr>
        <td class="label">
            <?php echo $this->_var['lang']['touch_img']; ?>
        </td>
        <td>
            <input type="file" name="touch_img" id="touch_img" size="45">
            <?php if ($this->_var['group_buy']['touch_img'] != ""): ?>
            <input type="button" value="<?php echo $this->_var['lang']['drop_touch_img']; ?>" onclick="if (confirm('<?php echo $this->_var['lang']['confirm_drop_img']; ?>'))location.href='group_buy.php?act=drop_img&id=<?php echo $this->_var['group_buy']['act_id']; ?>'">
            <?php endif; ?>
            </span>
        </td>
    </tr>
