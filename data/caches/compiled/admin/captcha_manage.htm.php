...
<tr>
  ...
  <img src="index.php?act=captcha&<?php echo $this->_var['rand']; ?>" alt="captcha" style="vertical-align: middle;cursor: pointer;" onClick="this.src='index.php?act=captcha&'+Math.random()" />
  </td>
  <td>
