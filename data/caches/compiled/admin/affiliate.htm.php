...
<form method="post" action="affiliate.php">
            <table width="100%" border="0" cellspacing="0" cellpadding="4">
                <tr>
                    ...
                    <input type="radio" name="separate_by" value="0" <?php if (! $this->_var['config']['config']['separate_by'] || $this->_var['config']['config']['separate_by'] == 0): ?> checked="true" <?php endif; ?> onClick="actDiv('listDiv','');">
                    <?php echo $this->_var['lang']['separate_by']['0']; ?>
                    <input type="radio" name="separate_by" value="1" <?php if ($this->_var['config']['config']['separate_by'] == 1): ?> checked="true" <?php endif; ?> onClick="actDiv('listDiv','none');">
                    <?php echo $this->_var['lang']['separate_by']['1']; ?>
                ...
                <tr><td></td>
                    ...
                    <input type="submit" value="<?php echo $this->_var['lang']['button_submit']; ?>" class="button" /></td>
