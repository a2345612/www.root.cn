...
?>
		...
		<?php else: ?>
		<li><a href="<?php echo $this->_var['gb_goods']['goods_img']; ?>"><img src="<?php echo $this->_var['gb_goods']['goods_img']; ?>" alt="<?php echo $this->_var['gb_goods']['goods_name']; ?>" /></a></li>
        <?php endif; ?>
      </ul>
    </div>
  </div>
  ...
  <div class="goods-info ect-padding-tb">
    ...
    <section class="ect-margin-tb ect-margin-lr ">
      <p><span class="pull-left"><?php echo $this->_var['lang']['gb_cur_price']; ?><strong class="ect-colory"><?php echo $this->_var['group_buy']['formated_cur_price']; ?></strong></span><span class="pull-right"><?php echo $this->_var['lang']['sort_sales']; ?>：<?php echo $this->_var['sales_count']; ?> 件</span></p>
