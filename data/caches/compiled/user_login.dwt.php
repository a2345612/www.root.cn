...
<div class="padding-all b-color-f">
	...
	<div class="other-login">
		...
		<ul class="dis-box">
			<?php if ($this->_var['ectouch_auth']['qq']): ?>
			<li class="box-flex"><a href="<?php echo url('oauth/index',array('type' => 'qq', 'back_url' => $this->_var['back_act']));?>"><span class="qq"><i class="iconfont icon-qq"></i></span></a></li>
			<?php endif; ?>
			<?php if ($this->_var['ectouch_auth']['weibo']): ?>
			<li class="box-flex"><a href="<?php echo url('oauth/index',array('type' => 'weibo', 'back_url' => $this->_var['back_act']));?>"><span class="weibo"><i class="iconfont icon-weibo"></i></span></a></li>
			<?php endif; ?>
			<?php if ($this->_var['is_wechat']): ?>
			<li class="box-flex"><a href="<?php echo url('oauth/index',array('type' => 'weixin', 'back_url' => $this->_var['back_act'],'from' => 'user_login'));?>"><span class="weixin"><i class="iconfont icon-weibiaoti1"></i></span></a></li>
			<?php endif; ?>
		</ul>
	</div>
</div>
