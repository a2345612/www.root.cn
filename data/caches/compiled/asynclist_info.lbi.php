...
<div class="flow-set-adr of-hidden padding-all ">
	<div class="ect-select fl">
		<label class="dis-box  <?php if ($this->_var['consignee']['address_id'] == $this->_var['consignee']['adds_id']): ?>active<?php endif; ?>" onclick ="edit_address_info(<?php echo $this->_var['consignee']['address_id']; ?>)">
			<i class="select-btn"></i>
			<span class="box-flex" >设为默认</span>
		</label>
	</div>
	<div class="fr"><a href="<?php echo $this->_var['consignee']['url']; ?>"><i class="iconfont icon-bianji"></i>编辑</a><a href="<?php echo url('user/del_address_list', array('id'=>$this->_var['consignee']['address_id']));?>"><i class="iconfont icon-xiao10"></i>删除</a></div>
</div>
<div class="flow-have-adr padding-all">
	<p class="f-h-adr-title">
		<label><?php echo $this->_var['consignee']['consignee']; ?></label><span class="ect-colory"><?php echo $this->_var['consignee']['mobile']; ?></span></p>
	<p class="f-h-adr-con t-remark m-top04"><?php echo $this->_var['consignee']['address']; ?></p>
</div>
<?php endif; ?>
 

 
<?php if ($this->_var['flow_consignee']): ?>
<div class="flow-set-adr of-hidden padding-all ">
	<div class="ect-select fl">
		<label class="dis-box  <?php if ($this->_var['flow_consignee']['address_id'] == $this->_var['flow_consignee']['adds_id']): ?>active<?php endif; ?>" onclick ="flow_edit_address_info(<?php echo $this->_var['flow_consignee']['address_id']; ?>)">
			<i class="select-btn"></i>
			<span class="box-flex" >设为默认</span>
		</label>
	</div>
	<div class="fr"><a href="<?php echo $this->_var['flow_consignee']['url']; ?>"><i class="iconfont icon-bianji"></i>编辑</a><a href="<?php echo url('flow/drop_consignee', array('id'=>$this->_var['flow_consignee']['address_id']));?>"><i class="iconfont icon-xiao10"></i>删除</a></div>
</div>
<div class="flow-have-adr padding-all">
	<p class="f-h-adr-title">
		<label><?php echo $this->_var['flow_consignee']['consignee']; ?></label><span class="ect-colory"><?php echo $this->_var['flow_consignee']['mobile']; ?></span></p>
	<p class="f-h-adr-con t-remark m-top04"><?php echo $this->_var['flow_consignee']['address']; ?></p>
</div>
<?php endif; ?>
...
<dl>
  ...
  <dd>
    <div class="flow-del text-center">
	<a onclick="addToCart(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)" href="javascript:;"><?php echo $this->_var['lang']['btn_add_to_cart']; ?></a></div>
  </dd>
</dl>
